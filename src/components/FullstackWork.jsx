...
const FullstackWork = () => {
  ...
  const visibleProjects = isSmallScreen ? FullstackProjects.slice(0, 5) : FullstackProjects;

  return (
    <>
       <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} `}>My work</p>
        <h2 className={`${styles.sectionHeadText}`}>Fullstack Projects.</h2>
      </motion.div>
...
export default SectionWrapper(FullstackWork, "fullstack work")
